...
```
fastp --in1 ~/2020-NSURP/raw_data/CSM7KOJE_1.fastq.gz \
  --in2 ~/2020-NSURP/raw_data/CSM7KOJE_2.fastq.gz \
...
```
Estimated number of unique 32-mers in SRR1211157_1.trim.fastq.gz: 120753108
Estimated number of unique 32-mers in SRR1211157_2.trim.fastq.gz: 121231542
Total estimated number of unique 32-mers: 164426731
```

The k-mer trimmed file (kmer output) has an estimated 163890994 unique 32-mers.
```
Estimated number of unique 32-mers in SRR1211157.kmertrim.fq.gz: 163890994
