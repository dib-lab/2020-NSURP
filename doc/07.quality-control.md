...
fastp --in1 SRR1211157_1.fastq.gz \
  ...
  --out1 SRR1211157_1.fastq.trim.gz \
  --out2 SRR1211157_2.fastq.trim.gz \
...
Like in [downloading sequencing data](06.download-assess-ibd-data.md), you can use `scp` to copy the html report to your computer:
...
Since you already have `sourmash` installed, you may find that nothing needed to be installed.
If not, `khmer` should be installed into your environment.
...
interleave-reads.py SRR1211157_1.trim.fastq.gz SRR1211157_2.trim.fastq.gz | 
        trim-low-abund.py --gzip -C 3 -Z 18 -M 20e9 -V - -o SRR1211157.abundtrim.fq.gz
```
