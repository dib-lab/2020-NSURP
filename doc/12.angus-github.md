...
You’ll need to sign up for a free account on [GitHub.com](https://github.com/). It’s as simple as signing up for any other social network. Keep the email you picked handy; we’ll be referencing it again in the lesson.

`Git` is installed on many system, but if you don't already have it, instructions to install Git for Windows, Mac or Linux can be found [here](https://git-scm.com/downloads).
...
![newrepo](_static/git_new_repo.png)
...
![createrepo](_static/git_create_repo.png)
...
![gitworking](_static/git_working.png)


## Connect Your Local Repository To Your GitHub Repository Online

![gitremote](_static/git_remote.png)
